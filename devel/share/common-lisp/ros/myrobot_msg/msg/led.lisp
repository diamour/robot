...
(cl:defmethod cl:initialize-instance :after ((m <led>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'led)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name myrobot_msg-msg:<led> is deprecated: use myrobot_msg-msg:led instead.")))

(cl:ensure-generic-function 'command-val :lambda-list '(m))
(cl:defmethod command-val ((m <led>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader myrobot_msg-msg:command-val is deprecated.  Use myrobot_msg-msg:command instead.")
  (command m))
